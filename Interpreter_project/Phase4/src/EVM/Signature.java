...
public class Signature {
    ...
    private String[] signature; // this String array contains the types of the method's parameters and the return type
    private String returnType;

    public Signature(String sig) {
	stringsig = sig;    // stringsig = "(signature)"
	...
	List<String> strings = new ArrayList<String>(); // signatures (parameters) of the method will be stored here
