...
public class InstInfo {
	...
	static Hashtable<String,InstInfo> infos;	// declaration of hashtable
												// String - name (key), InstInfo - info of instruction (value)
	...
	// initialize 'static' Hashtable
	static {
		infos = new Hashtable<String,InstInfo>(); 	// creation/allocation of hashtable
